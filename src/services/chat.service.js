...
class ChatService {
  ...
  getAllPublicChannelMessages(channelId, page, size) {
    return api
      .get("/api/channel/public/getAllMessages", {
        headers: authHeader(),
        params: {
          channelId: channelId,
  ...
  getPublicChannelMessagesSince(channelId, since, page, size) {
    return api
      .get("/api/channel/public/getMessagesSince", {
        headers: authHeader(),
        params: {
          channelId: channelId,
          since: since,
  ...
  sendPublicChannelMessage(channelId, message) {
    return api
      .post(
        "/api/channel/public/publishMessage",
  ...
  subscibeToPublicChannel(channelId) {
    return new WebSocket(
      api.defaults.baseURL.replace("http", "ws") +
        "/ws/channel/public/subscribe?channelId=" +
        channelId +
        "&access_token=" +
        encodeURIComponent(
  ...
  getPrivateChannelProfile(channelId) {
    return api
      .get("/api/channel/private/profile", {
        headers: authHeader(),
  ...
  getAllPrivateChannelMessages(page, size) {
    return api
      .get("/api/channel/private/getAllMessages", {
        headers: authHeader(),
        params: { page: page, size: size },
      })
      .then((response) => {
  ...
  getPrivateChannelMessagesSince(since, page, size) {
    return api
      .get("/api/channel/private/getMessagesSince", {
        headers: authHeader(),
        params: { since: since, pageRequest: { page: page, size: size } },
      })
      .then((response) => {
        return response.data;
      });
  ...
  sendPrivateChannelMessage(channelId, message) {
    return api
      .post(
        "/api/channel/private/publishMessage",
        { channelId: channelId, message: message },
        { headers: authHeader() },
      )
      .then((response) => {
  ...
  subscibeToPrivateChannel() {
    return new WebSocket(
      api.defaults.baseURL.replace("http", "ws") +
        "/ws/channel/private/subscribe?access_token=" +
        encodeURIComponent(
          (JSON.parse(localStorage.getItem("user")) || {}).access_token || "",
        ),
    );
  ...
  blockPrivateChannel(channelId, isBlocked) {
    return api.post(
      "/api/channel/private/blockage",
      { channelId: channelId, isBlocked: isBlocked },
      { headers: authHeader() },
    );
  }
  ...
  getGroupChannelMessagesSince(channelId, since, page, size) {
    return api
      .get("/api/channel/group/getMessagesSince", {
        headers: authHeader(),
        params: {
          channelId: channelId,
          since: since,
  ...
  subscibeToGroupChannel() {
    return new WebSocket(
      api.defaults.baseURL.replace("http", "ws") +
        "/ws/channel/group/subscribe?access_token=" +
        encodeURIComponent(
          (JSON.parse(localStorage.getItem("user")) || {}).access_token || "",
        ),
    );
  ...
  sendGroupChannelMessage(channelId, message) {
    return api
      .post(
        "/api/channel/group/publishMessage",
        { channelId: channelId, message: message },
        { headers: authHeader() },
      )
      .then((response) => {
  ...
  inviteToGroupChannel(channelId, targetUserId) {
    return api
      .post(
        "/api/channel/group/invite",
        { channelId: channelId, targetUserId: targetUserId },
        { headers: authHeader() },
      )
      .then((response) => {
        return response.data;
  ...
  getInvitations(since, page, size) {
    return api
      .get("/api/channel/group/invitation", {
        headers: authHeader(),
        params: { since: since, pageRequest: { page: page, size: size } },
      })
      .then((response) => {
  ...
  editAdmin(channelId, targetUserId, isAdmin) {
    return api
      .post(
        "/api/channel/group/editAdmin",
        { channelId: channelId, targetUserId: targetUserId, isAdmin: isAdmin },
        { headers: authHeader() },
      )
      .then((response) => {
        return response;
