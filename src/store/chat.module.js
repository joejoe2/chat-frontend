...
export const chat = {
  ...
  actions: {
    ...
    getPublicChannelList(context, pageParams) {
      return chatService
        .getPublicChannelList(pageParams.page, pageParams.size)
        .then((res) => {
    ...
    craetePublicChannel(context, payload) {
      return chatService
        .createPublicChannel(payload.channelName)
        .then((response) => {
          return response;
        })
        .catch((error) => {
    ...
    sendPublicChannelMessage(context, payload) {
      return chatService
        .sendPublicChannelMessage(payload.channelId, payload.message)
        .then((response) => {
          return response;
        })
        .catch((error) => {
    ...
    subscibeToPublicChannel(context, payload) {
      return Promise.resolve(
        chatService.subscibeToPublicChannel(payload.channelId),
      );
    },
    //private chat
    getPrivateChannelProfile(context, payload) {
      return chatService
        .getPrivateChannelProfile(payload.channelId)
        .then((res) => {
          return Promise.resolve(res);
        })
        .catch((error) => {
    ...
    getPrivateChannelList(context, payload) {
      return chatService
        .getPrivateChannelList(payload.page, payload.size)
        .then((res) => {
          return Promise.resolve(res);
        })
        .catch((error) => {
    ...
    createPrivateChannel(context, payload) {
      return chatService
        .createPrivateChannelBetween(payload.chatWith)
        .then((response) => {
          return response;
        })
        .catch((error) => {
    ...
    getPrivateChannelMessagesOfUser(context, payload) {
      return chatService
        .getAllPrivateChannelMessages(payload.page, payload.size)
        .then((response) => {
          return response;
        })
        .catch((error) => {
    ...
    getPrivateChannelMessagesOfUserSince(context, payload) {
      return chatService
        .getPrivateChannelMessagesSince(
          payload.since,
          payload.page,
          payload.size,
        )
    ...
    sendPrivateChannelMessage(context, payload) {
      return chatService
        .sendPrivateChannelMessage(payload.channelId, payload.message)
        .then((response) => {
          return response;
        })
        .catch((error) => {
    ...
    blockPrivateChannel(context, payload) {
      return chatService
        .blockPrivateChannel(payload.channelId, payload.isBlocked)
        .then(() => {
          return chatService
            .getPrivateChannelProfile(payload.channelId)
            .then((res) => {
    ...
    getGroupChannelProfile(context, payload) {
      return chatService
        .getGroupChannelProfile(payload.channelId)
        .then((res) => {
          return Promise.resolve(res);
        })
        .catch((error) => {
    ...
    getGroupChannelListSince(context, payload) {
      return chatService
        .getGroupChannelList(payload.since, payload.page, payload.size)
        .then((res) => {
          return Promise.resolve(res);
        })
        .catch((error) => {
    ...
    createGroupChannel(context, payload) {
      return chatService
        .createGroupChannel(payload.channelName)
        .then((response) => {
          return response;
        })
        .catch((error) => {
    ...
    sendGroupChannelMessage(context, payload) {
      return chatService
        .sendGroupChannelMessage(payload.channelId, payload.message)
        .then((response) => {
          return response;
        })
        .catch((error) => {
    ...
    inviteToGroupChannel(context, payload) {
      return chatService
        .inviteToGroupChannel(payload.channelId, payload.targetUserId)
        .then((response) => {
          return response;
        })
        .catch((error) => {
    ...
    acceptInvitationToGroupChannel(context, payload) {
      return chatService
        .acceptInvitationToGroupChannel(payload.channelId)
        .then((response) => {
          return response;
        })
        .catch((error) => {
    ...
    getInvitations(context, payload) {
      return chatService
        .getInvitations(payload.since, payload.page, payload.size)
        .then((response) => {
          return response;
        })
        .catch((error) => {
    ...
    kickOff(context, payload) {
      return chatService
        .kickOff(payload.channelId, payload.targetUserId)
        .then((response) => {
          return response;
        })
        .catch((error) => {
    ...
    editBanned(context, payload) {
      return chatService
        .editBanned(payload.channelId, payload.targetUserId, payload.isBanned)
        .then((response) => {
          return response;
        })
        .catch((error) => {
    ...
    editAdmin(context, payload) {
      return chatService
        .editAdmin(payload.channelId, payload.targetUserId, payload.isAdmin)
        .then((response) => {
          return response;
        })
        .catch((error) => {
